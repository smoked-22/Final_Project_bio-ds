...
def helper_backtrack(backtrack_arr, template_seq, seq, i, j, template_alignment, seq2_alignment):
    ...
    if backtrack_arr[i][j] == "d":
        return helper_backtrack(backtrack_arr, template_seq, seq, i-1, j, add_aa(template_seq, template_alignment, i-1), "-" + seq2_alignment)
    elif backtrack_arr[i][j] == "r":
        return helper_backtrack(backtrack_arr, template_seq, seq, i, j-1, add_aa(template_seq, template_alignment, "-"), seq[j-1] + seq2_alignment)
    elif backtrack_arr[i][j] == "m":
        return helper_backtrack(backtrack_arr, template_seq, seq, i-1, j-1, add_aa(template_seq, template_alignment, i-1), seq[j-1] + seq2_alignment)
